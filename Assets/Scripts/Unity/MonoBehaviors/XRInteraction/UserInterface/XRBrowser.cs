...
namespace TrekVRApplication
{
    ...
    public class XRBrowser : XRInteractableObject, IBrowserUI
    {
        ...
        {
            Debug.Log("TriggerDown on the XRBROWSER, YAAAAAAAAAAAAAAAS");
        ...
        public override void OnPadUntouch(XRController sender, RaycastHit hit)
        {
            _previousPadPosition = new Vector2(float.NaN, float.NaN);
        }

        // public override void OnPadSwipe(XRController sender, RaycastHit hit)
        // {
