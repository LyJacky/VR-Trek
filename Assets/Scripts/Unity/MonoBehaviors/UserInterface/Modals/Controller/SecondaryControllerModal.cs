...
namespace TrekVRApplication {
    ...
    public class SecondaryControllerModal : ControllerModal {
        ...
        private void TriggerClickedHandler(object sender) {
        ...
        private void MenuButtonPressedHandler(object sender) {
        ...
        private void MenuButtonLongPressedHandler(object sender) {
            StartActivity(ControllerModalActivity.Default);
        }

        // private void PadClickedHandler(object sender) {
