...
//     version 1.4.4
//     from Assets/InputActions/XRI Default Input Actions.inputactions
//
...
public partial class @CustomController : IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""XRCustomController"",
            ""id"": ""4e0d05a0-a549-40ae-8887-ec8fc781274d"",
            ""actions"": [
                {
                    ""name"": ""PrimaryButton"",
                    ""type"": ""Button"",
                    ""id"": ""07013bdc-a5df-4d30-91bd-f889dbf09aed"",
                    ""expectedControlType"": ""Button"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": false
                },
                {
                    ""name"": ""RightTrigger"",
                    ""type"": ""Value"",
                    ""id"": ""b01c28ee-0f2a-4740-85e8-6d02102aacd1"",
                    ""expectedControlType"": ""Axis"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": """",
                    ""id"": ""1f7124be-fec2-4d89-a014-c55856a643d4"",
                ...
                {
                    ""name"": """",
                    ""id"": ""eb9b19b7-b15d-4e01-a4a7-d2234e706029"",
                    ""path"": ""<XRController>{RightHand}/trigger"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
    ...
    ""controlSchemes"": [
        ...
        // XRCustomController
        m_XRCustomController = asset.FindActionMap("XRCustomController", throwIfNotFound: true);
        m_XRCustomController_PrimaryButton = m_XRCustomController.FindAction("PrimaryButton", throwIfNotFound: true);
        m_XRCustomController_RightTrigger = m_XRCustomController.FindAction("RightTrigger", throwIfNotFound: true);
    }
    ...
    public struct XRIHeadActions
    {
        ...
        public XRIHeadActions(@CustomController wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CustomController m_Wrapper;
        public XRILeftHandActions(@CustomController wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CustomController m_Wrapper;
        public XRILeftHandInteractionActions(@CustomController wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CustomController m_Wrapper;
        public XRILeftHandLocomotionActions(@CustomController wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CustomController m_Wrapper;
        public XRIRightHandActions(@CustomController wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CustomController m_Wrapper;
        public XRIRightHandInteractionActions(@CustomController wrapper) { m_Wrapper = wrapper; }
    ...
    {
        private @CustomController m_Wrapper;
        public XRIRightHandLocomotionActions(@CustomController wrapper) { m_Wrapper = wrapper; }
    ...
    // XRCustomController
    private readonly InputActionMap m_XRCustomController;
    private IXRCustomControllerActions m_XRCustomControllerActionsCallbackInterface;
    private readonly InputAction m_XRCustomController_PrimaryButton;
    private readonly InputAction m_XRCustomController_RightTrigger;
    public struct XRCustomControllerActions
    {
        private @CustomController m_Wrapper;
        public XRCustomControllerActions(@CustomController wrapper) { m_Wrapper = wrapper; }
        public InputAction @PrimaryButton => m_Wrapper.m_XRCustomController_PrimaryButton;
        public InputAction @RightTrigger => m_Wrapper.m_XRCustomController_RightTrigger;
        public InputActionMap Get() { return m_Wrapper.m_XRCustomController; }
        public void Enable() { Get().Enable(); }
        public void Disable() { Get().Disable(); }
        public bool enabled => Get().enabled;
        public static implicit operator InputActionMap(XRCustomControllerActions set) { return set.Get(); }
        public void SetCallbacks(IXRCustomControllerActions instance)
        {
            if (m_Wrapper.m_XRCustomControllerActionsCallbackInterface != null)
            {
                @PrimaryButton.started -= m_Wrapper.m_XRCustomControllerActionsCallbackInterface.OnPrimaryButton;
                @PrimaryButton.performed -= m_Wrapper.m_XRCustomControllerActionsCallbackInterface.OnPrimaryButton;
                @PrimaryButton.canceled -= m_Wrapper.m_XRCustomControllerActionsCallbackInterface.OnPrimaryButton;
                @RightTrigger.started -= m_Wrapper.m_XRCustomControllerActionsCallbackInterface.OnRightTrigger;
                @RightTrigger.performed -= m_Wrapper.m_XRCustomControllerActionsCallbackInterface.OnRightTrigger;
                @RightTrigger.canceled -= m_Wrapper.m_XRCustomControllerActionsCallbackInterface.OnRightTrigger;
            }
            m_Wrapper.m_XRCustomControllerActionsCallbackInterface = instance;
            if (instance != null)
            {
    ...
    public XRCustomControllerActions @XRCustomController => new XRCustomControllerActions(this);
    ...
    public interface IXRCustomControllerActions
    {
